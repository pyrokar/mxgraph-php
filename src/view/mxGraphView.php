...
class mxGraphView extends mxEventSource
{
     ...
     * @return mxRectangle
     */
    public function getBoundingBox(mxCellState $state, bool $recurse = true): mxRectangle
    {
        $bbox = null;
     ...
     * @return mxCell
     */
    public function validateCell(mxCell $cell, bool $visible = true): mxCell
    {
     ...
     * @return mxPoint
     */
    public function getPoint(mxCellState $state, mxGeometry $geometry = null): mxPoint
    {
        $x = $state->getCenterX();
        $y = $state->getCenterY();
