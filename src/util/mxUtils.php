...
class mxUtils
{
        ...
        if (is_string($text) && strlen($text) > 0) {
            ...
            if (function_exists('imageFontHeight') &&
                ...
                foreach ($lines as $line) {
                    $textWidth = max($textWidth, $charWidth * strlen($line));
                }
     ...
     */
    public static function getBoundingBox($rect, $rotation): ?mxRectangle
    {
        $result = null;
     ...
     * @return mxPoint
     */
    public static function getRotatedPoint($pt, $cos, $sin, $c = null): mxPoint
    {
        $c = $c ?? new mxPoint();
     ...
     * @return bool
     */
    public static function contains($state, $x, $y): bool
    {
     ...
     * @return null|mxPoint
     */
    public static function intersection($x0, $y0, $x1, $y1, $x2, $y2, $x3, $y3): ?mxPoint
    {
     ...
     * @return int
     */
    public static function indexOfStylename($style, $stylename): int
    {
     ...
     */
    public static function createXmlDocument(): DOMDocument
    {
     ...
     * @return DOMDocument
     */
    public static function loadXmlDocument($uri): DOMDocument
    {
     ...
     * @return DOMDocument
     */
    public static function parseXml($xml): DOMDocument
    {
        $doc = self::createXmlDocument();
        $doc->loadXML($xml);
     ...
     * @return int
     */
    public static function getFixedFontSize($fontSize, $fontFamily, $fontStyle = null): int
    {
        $font = 5;
